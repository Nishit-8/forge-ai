...
> **Feature:** F25  | **Status:** Product specification / Staff Engineer baseline  
...
### Business capability
ForgeAI will connect ForgeAI to engineering repositories and workflows.
### Business problem
AI engineering assistance becomes useful when it can operate against real repository artifacts through controlled access.
### Why this feature exists
AI engineering assistance becomes useful when it can operate against real repository artifacts through controlled access. The feature converts this need into a defined product capability with an observable user outcome.
### Capability added
...
### Business outcome
Connect a repository, inspect permitted artifacts, run a supported workflow and record the external reference. through the normal ForgeAI application path rather than as a standalone Mastra experiment.
...
- Required Mastra capability: **external tools, permissions, events, audit**.
...
**Concepts:** external tools, permissions, events, audit
...
~~~text
┌────────────────────────────────────────────────┐
│ ForgeAI  | GitHub Engineering Integration   │
├────────────────────────────────────────────────┤
│ Project / context                              │
│ User input / current state                     │
│ ┌────────────────────────────────────────────┐ │
│ │ Connect a repository, inspect permitted ar │ │
│ └────────────────────────────────────────────┘ │
...
|---|---|---|---|
| 1 | Connect a repository, inspect permitted artifacts, run a supported workflow and record the external reference. | Primary result is produced and shown in UI. | Main business problem is solved end-to-end. |
...
**Mastra:** Phase 18 — Production Hardening.  
