...
> **Feature:** F24  | **Status:** Product specification / Staff Engineer baseline  
...
### Business capability
ForgeAI will make approved knowledge available to authorized collaborators and AI.
### Business problem
Teams need shared context without exposing private or unrelated information.
### Why this feature exists
Teams need shared context without exposing private or unrelated information. The feature converts this need into a defined product capability with an observable user outcome.
### Capability added
**Permission-aware shared memory.**
...
### Business outcome
Add shared knowledge, retrieve it as authorized users, and verify unauthorized access is blocked. through the normal ForgeAI application path rather than as a standalone Mastra experiment.
...
- Required Mastra capability: **shared memory, scopes, recall, permissions**.
...
**Concepts:** shared memory, scopes, recall, permissions
...
~~~text
┌────────────────────────────────────────────────┐
│ ForgeAI  | Shared Project Memory            │
├────────────────────────────────────────────────┤
│ Project / context                              │
│ User input / current state                     │
│ ┌────────────────────────────────────────────┐ │
│ │ Add shared knowledge, retrieve it as autho │ │
│ └────────────────────────────────────────────┘ │
...
|---|---|---|---|
| 1 | Add shared knowledge, retrieve it as authorized users, and verify unauthorized access is blocked. | Primary result is produced and shown in UI. | Main business problem is solved end-to-end. |
...
**Mastra:** Phase 17 — Multi-user Collaboration and Shared Memory.  
