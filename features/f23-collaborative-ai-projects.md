...
> **Feature:** F23  | **Status:** Product specification / Staff Engineer baseline  
...
### Business capability
ForgeAI will let multiple humans and AI actors work in one project.
### Business problem
Real projects involve teams sharing work, decisions and permissions.
### Why this feature exists
Real projects involve teams sharing work, decisions and permissions. The feature converts this need into a defined product capability with an observable user outcome.
### Capability added
**Multi-user collaboration with AI participation.**
...
### Business outcome
Invite participants, assign work and verify shared activity and access boundaries. through the normal ForgeAI application path rather than as a standalone Mastra experiment.
...
- Required Mastra capability: **collaborative sessions, actor context, permissions**.
...
│ persistence    │ │ collaborative sess │
└────────────────┘ └──────────┬───────────┘
                              ▼
                       Gemini / External
~~~
...
**Concepts:** collaborative sessions, actor context, permissions
...
~~~text
┌────────────────────────────────────────────────┐
│ ForgeAI  | Collaborative AI Projects        │
├────────────────────────────────────────────────┤
│ Project / context                              │
│ User input / current state                     │
│ ┌────────────────────────────────────────────┐ │
│ │ Invite participants, assign work and verif │ │
│ └────────────────────────────────────────────┘ │
...
|---|---|---|---|
| 1 | Invite participants, assign work and verify shared activity and access boundaries. | Primary result is produced and shown in UI. | Main business problem is solved end-to-end. |
