...
> **Feature:** F01  | **Status:** Product specification / Staff Engineer baseline  
...
### Business capability
ForgeAI will manage projects and tasks.

### Business problem
Users need a reliable system of record for delivery work before AI can safely act on it.

### Why this feature exists
Users need a reliable system of record for delivery work before AI can safely act on it. The feature converts this need into a defined product capability with an observable user outcome.

### Capability added
**Persistent project/task lifecycle.**
...
### Business outcome
Create a project, add tasks, change status/priority, edit details, then reload the project. through the normal ForgeAI application path rather than as a standalone Mastra experiment.
...
- Required Mastra capability: **Domain services, API validation, repository boundary, LibSQL**.
...
**Concepts:** Domain services, API validation, repository boundary, LibSQL
...
~~~text
┌────────────────────────────────────────────────┐
│ ForgeAI  | Project & Task Management        │
├────────────────────────────────────────────────┤
│ Project / context                              │
│                                                │
│ User input / current state                     │
│ ┌────────────────────────────────────────────┐ │
│ │ Create a project, add tasks, change status │ │
│ └────────────────────────────────────────────┘ │
...
|---|---|---|---|
| 1 | Create a project, add tasks, change status/priority, edit details, then reload the project. | The primary result is produced and shown in the UI. | The main business problem is solved end-to-end. |
...
**Mastra dependency:** Phase 0 — Foundation.  
