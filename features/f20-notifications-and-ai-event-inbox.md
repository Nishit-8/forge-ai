# Notifications & AI Event Inbox

> **Feature:** F20  | **Status:** Product specification / Staff Engineer baseline  
...
### Business capability
ForgeAI will surface important AI and workflow events.
### Business problem
Users need one actionable place for approvals, failures and completed work instead of monitoring dashboards.
### Why this feature exists
Users need one actionable place for approvals, failures and completed work instead of monitoring dashboards. The feature converts this need into a defined product capability with an observable user outcome.
### Capability added
**Actionable AI event inbox.**
...
### Business outcome
Trigger an event, open the inbox, inspect details and mark it handled. through the normal ForgeAI application path rather than as a standalone Mastra experiment.
...
- Required Mastra capability: **signals, event payloads, subscriptions**.
...
**Concepts:** signals, event payloads, subscriptions
...
~~~text
┌────────────────────────────────────────────────┐
│ ForgeAI  | Notifications & AI Event Inbox   │
├────────────────────────────────────────────────┤
│ Project / context                              │
│ User input / current state                     │
│ ┌────────────────────────────────────────────┐ │
│ │ Trigger an event, open the inbox, inspect  │ │
│ └────────────────────────────────────────────┘ │
...
|---|---|---|---|
| 1 | Trigger an event, open the inbox, inspect details and mark it handled. | Primary result is produced and shown in UI. | Main business problem is solved end-to-end. |
...
**Mastra:** Phase 15 — Signals and Event-driven Agents.  
