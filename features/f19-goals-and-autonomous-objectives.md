...
> **Feature:** F19  | **Status:** Product specification / Staff Engineer baseline  
...
### Business capability
ForgeAI will pursue defined outcomes under constraints.
### Business problem
Users may want recurring progress toward an objective without issuing every instruction manually.
### Why this feature exists
Users may want recurring progress toward an objective without issuing every instruction manually. The feature converts this need into a defined product capability with an observable user outcome.
### Capability added
**Bounded autonomy.**
...
### Business outcome
Define a goal, constraints and success criteria, run an objective cycle, and inspect proposed/actual work. through the normal ForgeAI application path rather than as a standalone Mastra experiment.
...
- Required Mastra capability: **goal state, evaluation loops, tool policies**.
...
**Concepts:** goal state, evaluation loops, tool policies
...
~~~text
┌────────────────────────────────────────────────┐
│ ForgeAI  | Goals & Autonomous Objectives    │
├────────────────────────────────────────────────┤
│ Project / context                              │
│ User input / current state                     │
│ ┌────────────────────────────────────────────┐ │
│ │ Define a goal, constraints and success cri │ │
│ └────────────────────────────────────────────┘ │
...
|---|---|---|---|
| 1 | Define a goal, constraints and success criteria, run an objective cycle, and inspect proposed/actual work. | Primary result is produced and shown in UI. | Main business problem is solved end-to-end. |
...
**Mastra:** Phase 14 — Goals and Autonomous Objectives.  
