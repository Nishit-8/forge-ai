...
> **Feature:** F13  | **Status:** Product specification / Staff Engineer baseline  
...
### Business capability
ForgeAI will retain useful project knowledge beyond raw chat.
### Business problem
Important decisions and observations should be reusable without replaying every conversation.
### Why this feature exists
Important decisions and observations should be reusable without replaying every conversation. The feature converts this need into a defined product capability with an observable user outcome.
### Capability added
**Long-term project-scoped knowledge.**
...
### Business outcome
Record project knowledge, ask a related question later, and verify relevant recall with provenance. through the normal ForgeAI application path rather than as a standalone Mastra experiment.
...
- Required Mastra capability: **working memory, observations, semantic recall**.
...
**Concepts:** working memory, observations, semantic recall
...
~~~text
┌────────────────────────────────────────────────┐
│ ForgeAI  | Project Memory & Knowledge       │
├────────────────────────────────────────────────┤
│ Project / context                              │
│ User input / current state                     │
│ ┌────────────────────────────────────────────┐ │
│ │ Record project knowledge, ask a related qu │ │
│ └────────────────────────────────────────────┘ │
...
|---|---|---|---|
| 1 | Record project knowledge, ask a related question later, and verify relevant recall with provenance. | Primary result is produced and shown in UI. | Main business problem is solved end-to-end. |
