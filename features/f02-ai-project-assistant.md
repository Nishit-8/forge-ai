...
> **Feature:** F02  | **Status:** Product specification / Staff Engineer baseline  
...
### Business capability
ForgeAI will ask ForgeAI questions about a project.

### Business problem
Users need conversational help grounded in the selected project's actual state.

### Why this feature exists
Users need conversational help grounded in the selected project's actual state. The feature converts this need into a defined product capability with an observable user outcome.

### Capability added
**Project-scoped AI assistance.**
...
### Business outcome
Open a project and ask a question about its tasks or status. through the normal ForgeAI application path rather than as a standalone Mastra experiment.
...
- Required Mastra capability: **Agent, instructions, model, request context**.
...
**Concepts:** Agent, instructions, model, request context
...
~~~text
┌────────────────────────────────────────────────┐
│ ForgeAI  | AI Project Assistant             │
├────────────────────────────────────────────────┤
│ Project / context                              │
│                                                │
│ User input / current state                     │
│ ┌────────────────────────────────────────────┐ │
│ │ Open a project and ask a question about it │ │
│ └────────────────────────────────────────────┘ │
...
|---|---|---|---|
| 1 | Open a project and ask a question about its tasks or status. | The primary result is produced and shown in the UI. | The main business problem is solved end-to-end. |
...
**Mastra dependency:** Phase 1 — Agent Foundation.  
