...
> **Feature:** F17  | **Status:** Product specification / Staff Engineer baseline  
...
### Business capability
ForgeAI will provide explicit modes with different behavior and permissions.
### Business problem
Chat, planning, investigation and execution need different instructions, tools and output contracts.
### Why this feature exists
Chat, planning, investigation and execution need different instructions, tools and output contracts. The feature converts this need into a defined product capability with an observable user outcome.
### Capability added
**Mode-aware AI interaction.**
...
### Business outcome
Switch mode and submit the same intent; verify behavior and capabilities change according to the mode. through the normal ForgeAI application path rather than as a standalone Mastra experiment.
...
- Required Mastra capability: **harness, modes, instructions, tool filtering**.
...
**Concepts:** harness, modes, instructions, tool filtering
...
~~~text
┌────────────────────────────────────────────────┐
│ ForgeAI  | Assistant Modes                  │
├────────────────────────────────────────────────┤
│ Project / context                              │
│ User input / current state                     │
│ ┌────────────────────────────────────────────┐ │
│ │ Switch mode and submit the same intent; ve │ │
│ └────────────────────────────────────────────┘ │
...
|---|---|---|---|
| 1 | Switch mode and submit the same intent; verify behavior and capabilities change according to the mode. | Primary result is produced and shown in UI. | Main business problem is solved end-to-end. |
