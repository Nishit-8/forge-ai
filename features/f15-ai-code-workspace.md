...
> **Feature:** F15  | **Status:** Product specification / Staff Engineer baseline  
...
### Business capability
ForgeAI will inspect and work with code through controlled capabilities.
### Business problem
Engineering users need AI against actual code while execution remains bounded and observable.
### Why this feature exists
Engineering users need AI against actual code while execution remains bounded and observable. The feature converts this need into a defined product capability with an observable user outcome.
### Capability added
**Governed code-focused AI workspace.**
...
### Business outcome
Open a workspace, request inspection/change, review the operation and observe controlled results. through the normal ForgeAI application path rather than as a standalone Mastra experiment.
...
- Required Mastra capability: **Code Mode, tools, approvals, controlled execution**.
...
**Concepts:** Code Mode, tools, approvals, controlled execution
...
~~~text
┌────────────────────────────────────────────────┐
│ ForgeAI  | AI Code Workspace                │
├────────────────────────────────────────────────┤
│ Project / context                              │
│ User input / current state                     │
│ ┌────────────────────────────────────────────┐ │
│ │ Open a workspace, request inspection/chang │ │
│ └────────────────────────────────────────────┘ │
...
|---|---|---|---|
| 1 | Open a workspace, request inspection/change, review the operation and observe controlled results. | Primary result is produced and shown in UI. | Main business problem is solved end-to-end. |
