# Sessions, Permissions & Tool Access

> **Feature:** F18  | **Status:** Product specification / Staff Engineer baseline  
...
### Business capability
ForgeAI will control who can use which AI capabilities.
### Business problem
AI actions must respect server-side identity and authorization, not only UI controls.
### Why this feature exists
AI actions must respect server-side identity and authorization, not only UI controls. The feature converts this need into a defined product capability with an observable user outcome.
### Capability added
**Session-aware permissioned AI.**
...
### Business outcome
Use users with different permissions and attempt allowed/disallowed actions; verify enforcement and audit results. through the normal ForgeAI application path rather than as a standalone Mastra experiment.
...
- Required Mastra capability: **sessions, RequestContext, tool filtering, permissions**.
...
**Concepts:** sessions, RequestContext, tool filtering, permissions
...
~~~text
┌────────────────────────────────────────────────┐
│ ForgeAI  | Sessions, Permissions & Tool Acc │
├────────────────────────────────────────────────┤
│ Project / context                              │
│ User input / current state                     │
│ ┌────────────────────────────────────────────┐ │
│ │ Use users with different permissions and a │ │
│ └────────────────────────────────────────────┘ │
...
|---|---|---|---|
| 1 | Use users with different permissions and attempt allowed/disallowed actions; verify enforcement and audit results. | Primary result is produced and shown in UI. | Main business problem is solved end-to-end. |
...
**Mastra:** Phase 13 — Harness, Sessions, Modes, and Permissions.  
